...
const API_BASE_URL = 'https://applies-respond-breaking-translations.trycloudflare.com';
// ↑ CHANGE THIS VALUE TO SWITCH ENVIRONMENTS ↑
...
window.getApiBase = function() {
  return window.API_BASE_URL || 'https://applies-respond-breaking-translations.trycloudflare.com';
}
